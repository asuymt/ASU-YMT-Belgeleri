...
## 5.0 ETKİNLİK VE SOSYAL İŞLER KOMİTESİ

* **Lider:** Etkinlik Direktörü
* **Amacı:** Topluluğun "kalbi" ve "sosyal yüzü"dür. Üye aidiyetini güçlendirecek sosyal faaliyetler ve tüm komitelerin ihtiyaç duyduğu organizasyonların lojistiğini yönetir.
* **Ekipler:**
    * **Organizasyon Ekibi:** Topluluğun *tüm* etkinliklerinin (seminer, atölye, konferans, hackathon) lojistik gücüdür. Mekan (salon, amfi) ayarlar, teknik donanımı (ses, projeksiyon) sağlar, kayıt masasını yönetir, ikramları organize eder ve konuşmacı/konuk ilişkilerini yürütür.
    * **Sosyal Faaliyetler Ekibi:** Üyeler arası bağı güçlendirir. Tanışma kahvaltıları, oyun turnuvaları, piknikler, teknik geziler ve sosyal sorumluluk projeleri düzenler.
...
## 7.0 MEDYA VE İLETİŞİM KOMİTESİ

* **Lider:** Sosyal Medya Direktörü
* **Amacı:** Topluluğun dijital kimliğini (marka) yönetir, tüm faaliyetlerin profesyonel bir dille duyurulmasını ve topluluk imajının güçlendirilmesini sağlar.
* **Ekipler:**
    * **İçerik Ekibi:** Topluluğun "sesi"dir. Sosyal medya (Instagram, LinkedIn) metinlerini, blog yazılarını, web sitesi içeriklerini ve video senaryolarını yazar.
    * **Tasarım ve Montaj Ekibi:** Topluluğun "görsel gücü"dür. Tüm afişleri, duyuru görsellerini (Photoshop, Figma vb.) ve videoları (montaj, kurgu) üretir.
    * **Sosyal Medya Yönetim Ekibi:** Üretilen içerikleri bir yayın takvimiyle (Instagram, LinkedIn vb.) paylaşır. Takipçi etkileşimlerini (yorum, DM) yönetir ve analizleri raporlar.
    * **Topluluk Web Sitesi Ekibi:** Topluluğun resmi web sitesinin teknik altyapısını (hosting, güvenlik, güncelleme) yönetir ve içeriklerin siteye girilmesini sağlar.

<br><br>


## 8.0 BAĞIMSIZ GRUPLAR (Teknoloji Odak Grupları)
